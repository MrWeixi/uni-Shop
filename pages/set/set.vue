<template>
	<view class="container">
		...
		<view class="list-cell m-t">
			...
			<switch checked color="#13227A" @change="switchChange" />
		</view>
		...
		<view class="list-cell b-b" @click="navTo('关于Dcloud')" hover-class="cell-hover" :hover-stay-time="50">
			<text class="cell-tit">关于ADS之家</text>
			<text class="cell-more yticon icon-you"></text>
		</view>
		...
		<view class="list-cell log-out-btn" @click="toLogout">
			<text class="cell-tit" style="color: #13227A;">退出登录</text>
		</view>
	</view>
</template>
