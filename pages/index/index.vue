	...
	<view class="index">		
			<view class="text-area">
				<view class="input_search">
					<image style="width: 48rpx;height: 48rpx;" src="../../static/image/search.png"></image>
					<input type="text" disabled="true" placeholder="请输入商品关键字" confirm-type="search" placeholder-style="color:#ccc;" />
				</view>
			</view>
			<view class="nav">
			...
			<swiper class="swiper" :indicator-dots="true" :autoplay="true" indicator-color="rgba(0, 0, 0, .3)" circular="true"
			...
			<view class="title">
				<text style="font-size: 40rpx;">好物日历</text><text style="font-size:28rpx;margin-left: 30rpx;">每日精选推荐</text>
			</view>
			<view class="list-content">
				<block v-for="(items,index) in getLists" :key="index">
					<view class="list-item">
						...
						<view class="shop"><text>￥{{items.count}}</text>
			...
			<view class="title" style="display: flex;justify-content: space-between;">
				<view><text style="font-size: 40rpx;">新品尝鲜</text><text style="font-size:28rpx;margin-left: 30rpx;">每周二,周四上新</text>
				</view>
				<view style="font-size:26rpx; color: #666;"><text style="margin-right: 8rpx;">更多</text><text style="font-family: '黑体';">></text></view>
			</view>
			<view class="list-content">
				<block v-for="(items,index) in getLists" :key="index">
					<view class="list-item">
			...
			<!-- 顶部 -->
		<view class="to-top" @click="goTop" v-show="isshow">
			<image src="../../static/iconfont/top.png" mode="widthFix"></image>
		</view>
	</view>
			...
			.list-item {
				...
				.image {
					...
					.flash {
						...
						position: absolute;
						bottom: 0;
						background-color: rgba(0, 0, 122, .9);
						font-size: 24rpx;
						color: #fff;
						text-align: center;
					}
