...
Z([3,'邀请好友'])
Z([3,'../../static/iconfont/yijianfankui.png'])
Z([3,'意见反馈'])
...
var hMB=_mz(z,'ads-search',['bind:__l',1,'vueId',1,'vueSlots',2],[],e,s,gg)
var oNB=_mz(z,'input',['confirmType',4,'disabled',1,'placeholder',2,'placeholderStyle',3,'slot',4,'type',5],[],e,s,gg)
_(hMB,oNB)
_(cLB,hMB)
var cOB=_n('view')
...
var oVB=_mz(z,'text',['bindtap',15,'class',1,'data-event-opts',2,'id',3],[],tSB,aRB,gg)
var xWB=_oz(z,19,tSB,aRB,gg)
_(oVB,xWB)
_(eTB,oVB)
return eTB
}
oPB.wxXCkey=2
_2z(z,13,lQB,e,s,gg,oPB,'items','index','index')
_(cLB,cOB)
var oXB=_mz(z,'swiper',['circular',-1,'autoplay',20,'class',1,'duration',2,'indicatorActiveColor',3,'indicatorColor',4,'indicatorDots',5,'interval',6],[],e,s,gg)
var fYB=_v()
_(oXB,fYB)
var cZB=function(o2B,h1B,c3B,gg){
var l5B=_n('swiper-item')
_rz(z,l5B,'class',31,o2B,h1B,gg)
var a6B=_n('image')
_rz(z,a6B,'src',32,o2B,h1B,gg)
_(l5B,a6B)
_(c3B,l5B)
return c3B
}
fYB.wxXCkey=2
_2z(z,29,cZB,e,s,gg,fYB,'item','index','index')
_(cLB,oXB)
var t7B=_n('view')
_rz(z,t7B,'class',33,e,s,gg)
var e8B=_n('view')
var b9B=_mz(z,'image',['mode',-1,'src',34],[],e,s,gg)
_(e8B,b9B)
var o0B=_n('text')
...
_(t7B,e8B)
var oBC=_n('view')
var fCC=_mz(z,'image',['mode',-1,'src',36],[],e,s,gg)
_(oBC,fCC)
var cDC=_n('text')
...
_(t7B,oBC)
var oFC=_n('view')
var cGC=_mz(z,'image',['mode',-1,'src',38],[],e,s,gg)
_(oFC,cGC)
var oHC=_n('text')
...
var tKC=_n('text')
_rz(z,tKC,'style',41,e,s,gg)
var eLC=_oz(z,42,e,s,gg)
_(tKC,eLC)
_(aJC,tKC)
var bMC=_n('text')
_rz(z,bMC,'style',43,e,s,gg)
...
var oVC=_n('view')
_rz(z,oVC,'class',50,hSC,cRC,gg)
var aXC=_n('view')
_rz(z,aXC,'class',51,hSC,cRC,gg)
var eZC=_mz(z,'image',['mode',-1,'src',52],[],hSC,cRC,gg)
_(aXC,eZC)
var tYC=_v()
_(aXC,tYC)
if(_oz(z,53,hSC,cRC,gg)){tYC.wxVkey=1
var b1C=_n('view')
_rz(z,b1C,'class',54,hSC,cRC,gg)
var o2C=_oz(z,55,hSC,cRC,gg)
_(b1C,o2C)
_(tYC,b1C)
}
tYC.wxXCkey=1
_(oVC,aXC)
var x3C=_n('text')
_rz(z,x3C,'class',56,hSC,cRC,gg)
var o4C=_oz(z,57,hSC,cRC,gg)
_(x3C,o4C)
_(oVC,x3C)
var lWC=_v()
_(oVC,lWC)
if(_oz(z,58,hSC,cRC,gg)){lWC.wxVkey=1
var f5C=_n('view')
_rz(z,f5C,'class',59,hSC,cRC,gg)
var c6C=_oz(z,60,hSC,cRC,gg)
_(f5C,c6C)
_(lWC,f5C)
}
else{lWC.wxVkey=2
var h7C=_n('view')
_rz(z,h7C,'class',61,hSC,cRC,gg)
_(lWC,h7C)
}
var o8C=_n('view')
_rz(z,o8C,'class',62,hSC,cRC,gg)
var c9C=_n('text')
var o0C=_oz(z,63,hSC,cRC,gg)
_(c9C,o0C)
_(o8C,c9C)
var lAD=_mz(z,'image',['mode',-1,'src',64,'style',1],[],hSC,cRC,gg)
_(o8C,lAD)
_(oVC,o8C)
lWC.wxXCkey=1
_(oTC,oVC)
...
oPC.wxXCkey=2
_2z(z,48,fQC,e,s,gg,oPC,'items','index','index')
_(cLB,xOC)
var aBD=_mz(z,'view',['class',66,'style',1],[],e,s,gg)
var tCD=_n('view')
var eDD=_n('text')
_rz(z,eDD,'style',68,e,s,gg)
var bED=_oz(z,69,e,s,gg)
_(eDD,bED)
_(tCD,eDD)
var oFD=_n('text')
_rz(z,oFD,'style',70,e,s,gg)
var xGD=_oz(z,71,e,s,gg)
_(oFD,xGD)
_(tCD,oFD)
_(aBD,tCD)
var oHD=_n('view')
_rz(z,oHD,'style',72,e,s,gg)
var fID=_n('text')
_rz(z,fID,'style',73,e,s,gg)
var cJD=_oz(z,74,e,s,gg)
_(fID,cJD)
_(oHD,fID)
var hKD=_n('text')
_rz(z,hKD,'style',75,e,s,gg)
...
var oTD=_n('view')
_rz(z,oTD,'class',82,tQD,aPD,gg)
var oVD=_n('view')
_rz(z,oVD,'class',83,tQD,aPD,gg)
var cXD=_mz(z,'image',['mode',-1,'src',84],[],tQD,aPD,gg)
_(oVD,cXD)
var fWD=_v()
_(oVD,fWD)
if(_oz(z,85,tQD,aPD,gg)){fWD.wxVkey=1
var hYD=_n('view')
_rz(z,hYD,'class',86,tQD,aPD,gg)
var oZD=_oz(z,87,tQD,aPD,gg)
_(hYD,oZD)
_(fWD,hYD)
}
fWD.wxXCkey=1
_(oTD,oVD)
var c1D=_n('text')
_rz(z,c1D,'class',88,tQD,aPD,gg)
var o2D=_oz(z,89,tQD,aPD,gg)
_(c1D,o2D)
_(oTD,c1D)
var xUD=_v()
_(oTD,xUD)
if(_oz(z,90,tQD,aPD,gg)){xUD.wxVkey=1
var l3D=_n('view')
_rz(z,l3D,'class',91,tQD,aPD,gg)
var a4D=_oz(z,92,tQD,aPD,gg)
_(l3D,a4D)
_(xUD,l3D)
}
else{xUD.wxVkey=2
var t5D=_n('view')
_rz(z,t5D,'class',93,tQD,aPD,gg)
_(xUD,t5D)
}
var e6D=_n('view')
_rz(z,e6D,'class',94,tQD,aPD,gg)
var b7D=_n('text')
var o8D=_oz(z,95,tQD,aPD,gg)
_(b7D,o8D)
_(e6D,b7D)
var x9D=_mz(z,'image',['mode',-1,'src',96,'style',1],[],tQD,aPD,gg)
_(e6D,x9D)
_(oTD,e6D)
xUD.wxXCkey=1
_(eRD,oTD)
...
oND.wxXCkey=2
_2z(z,80,lOD,e,s,gg,oND,'items','index','index')
_(cLB,cMD)
var o0D=_n('view')
_rz(z,o0D,'class',98,e,s,gg)
var fAE=_mz(z,'image',['mode',-1,'src',99],[],e,s,gg)
_(o0D,fAE)
_(cLB,o0D)
var cBE=_n('view')
_rz(z,cBE,'class',100,e,s,gg)
var hCE=_n('view')
_rz(z,hCE,'class',101,e,s,gg)
var oDE=_oz(z,102,e,s,gg)
_(hCE,oDE)
_(cBE,hCE)
var cEE=_mz(z,'goods-list',['bind:__l',103,'goodsList',1,'vueId',2],[],e,s,gg)
_(cBE,cEE)
_(cLB,cBE)
var oFE=_n('view')
var lGE=_mz(z,'view',['bindtap',106,'class',1,'data-event-opts',2,'hidden',3],[],e,s,gg)
var aHE=_mz(z,'image',['mode',110,'src',1],[],e,s,gg)
_(lGE,aHE)
_(oFE,lGE)
_(cLB,oFE)
var tIE=_mz(z,'uni-load-more',['bind:__l',112,'status',1,'vueId',2],[],e,s,gg)
_(cLB,tIE)
_(r,cLB)
return r
}
...
var fOE=_mz(z,'image',['class',3,'src',1],[],e,s,gg)
_(oNE,fOE)
_(xME,oNE)
var cPE=_n('view')
...
_(oLE,cSE)
_(bKE,oLE)
var eXE=_mz(z,'view',['bindtouchend',13,'bindtouchmove',1,'bindtouchstart',2,'class',3,'data-event-opts',4,'style',5],[],e,s,gg)
var bYE=_mz(z,'image',['class',19,'src',1],[],e,s,gg)
_(eXE,bYE)
var oZE=_n('view')
...
var oXF=_n('view')
var cYF=_n('view')
var oZF=_mz(z,'image',['mode',-1,'src',40],[],e,s,gg)
_(cYF,oZF)
_(oXF,cYF)
var l1F=_n('view')
...
var t3F=_n('view')
var e4F=_n('view')
var b5F=_mz(z,'image',['mode',-1,'src',42],[],e,s,gg)
_(e4F,b5F)
_(t3F,e4F)
var o6F=_n('view')
...
var o8F=_n('view')
var f9F=_n('view')
var c0F=_mz(z,'image',['mode',-1,'src',44],[],e,s,gg)
_(f9F,c0F)
_(o8F,f9F)
var hAG=_n('view')
...
var cCG=_n('view')
var oDG=_n('view')
var lEG=_mz(z,'image',['mode',-1,'src',46],[],e,s,gg)
_(oDG,lEG)
_(cCG,oDG)
var aFG=_n('view')
var tGG=_oz(z,47,e,s,gg)
_(aFG,tGG)
_(cCG,aFG)
_(hWF,cCG)
var eHG=_n('view')
var bIG=_n('view')
var oJG=_mz(z,'image',['mode',-1,'src',48],[],e,s,gg)
_(bIG,oJG)
_(eHG,bIG)
var xKG=_n('view')
...
var e0G=_n('view')
var bAH=_n('view')
var oBH=_mz(z,'image',['mode',-1,'src',64],[],e,s,gg)
_(bAH,oBH)
_(e0G,bAH)
var xCH=_n('view')
var oDH=_oz(z,65,e,s,gg)
_(xCH,oDH)
_(e0G,xCH)
_(t9G,e0G)
var fEH=_n('view')
var cFH=_n('view')
var hGH=_mz(z,'image',['mode',-1,'src',66],[],e,s,gg)
_(cFH,hGH)
_(fEH,cFH)
var oHH=_n('view')
...
var oJH=_n('view')
var lKH=_n('view')
var aLH=_mz(z,'image',['mode',-1,'src',68],[],e,s,gg)
_(lKH,aLH)
_(oJH,lKH)
var tMH=_n('view')
...
var lYH=_mz(z,'image',['src',3,'style',1],[],e,s,gg)
_(oXH,lYH)
var aZH=_mz(z,'input',['confirmType',5,'placeholder',1,'placeholderStyle',2,'type',3],[],e,s,gg)
_(oXH,aZH)
_(cWH,oXH)
_(oVH,cWH)
var t1H=_n('view')
_rz(z,t1H,'class',9,e,s,gg)
var e2H=_mz(z,'goods-list',['bind:__l',10,'goodsList',1,'vueId',2],[],e,s,gg)
_(t1H,e2H)
_(oVH,t1H)
var b3H=_mz(z,'uni-load-more',['bind:__l',13,'status',1,'vueId',2],[],e,s,gg)
_(oVH,b3H)
_(r,oVH)
return r
}
